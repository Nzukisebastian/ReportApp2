...
/**
 * Created by SEBASTIAN on 7/18/2018.
 */


public class InvestigatorLoginBackend extends AsyncTask<String,Void,String> {
    Context context;
    ...
    InvestigatorLoginBackend(Context ctx) {
        context = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url = "http://ictchops.me.ke/password/adminlogin.php";
