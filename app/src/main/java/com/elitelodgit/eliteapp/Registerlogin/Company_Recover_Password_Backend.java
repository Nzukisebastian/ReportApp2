...
public class Company_Recover_Password_Backend extends AsyncTask<String,Void,String> {
    ...
    Company_Recover_Password_Backend(Context ctx) {
        context = ctx;
    }
    ...
    protected void onPreExecute() {
        ...
        progressDialog = ProgressDialog.show(context, "Verifying email...", "Please wait...", true, true);
    }

    @Override
    protected String doInBackground(String... params) {
        String type = params[0];
        String login_url = "http://ictchops.me.ke/password/company_recover_password.php";
        String password_url = "http://ictchops.me.ke/password/client_recover_password.php";

        if (type.equals("companyrecover")) {
            try {
        ...
        }else if (type.equals("clientrecover")) {
            try {
                String email = params[1];
    ...
    protected void onPostExecute(String result) {
        ...
        if(result!=null && result.equals("New password code has been sent to your email!")){
            ...
            Toast.makeText(context,result,Toast.LENGTH_LONG).show();
            Intent i=new Intent(context,InvestigatorRegister.class);
            context.startActivity(i);
        }
